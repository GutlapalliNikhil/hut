...
#include "hut_msgs/Velocities.h"
//header file for cmd_subscribing to "cmd_vel"
#include "geometry_msgs/Twist.h"
//header file for pid server
#include "hut_msgs/PID.h"
//header file for imu
#include "hut_msgs/Imu.h"

#include "hut_base_config.h"
#include "Motor.h"
...
Kinematics kinematics(Kinematics::HUT_BASE, MAX_RPM, WHEEL_DIAMETER, FR_WHEELS_DISTANCE, LR_WHEELS_DISTANCE);
...
void PIDCallback(const hut_msgs::PID& pid);

ros::NodeHandle nh;

ros::Subscriber<geometry_msgs::Twist> cmd_sub("cmd_vel", commandCallback);
ros::Subscriber<hut_msgs::PID> pid_sub("pid", PIDCallback);

hut_msgs::Imu raw_imu_msg;
ros::Publisher raw_imu_pub("raw_imu", &raw_imu_msg);

hut_msgs::Velocities raw_vel_msg;
...
void PIDCallback(const hut_msgs::PID& pid)
{
    //callback function every time PID constants are received from hut_pid for tuning
